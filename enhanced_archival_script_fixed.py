#!/usr/bin/env python3
# coding: utf-8
## Fixed Enhanced TacobellUS_Prod_RewardsDataArchival.py 
## With proper signal handling and correct logging
...
def update_file_processing_log(status, error_message=None, total_batches=0, processed_batches=0, last_processed_batch=0, records_processed=0):
    ...
    if result is None:
        print(f"WARNING: Failed to update file processing log {file_processing_log_id}")
    else:
